...
const serverEnvSchema = z.object({
  ...
  // Tujuan forward notifikasi konfirmasi bukti pembayaran (Fase E, manual QRIS/e-wallet/bank).
  // Detail rekening/e-wallet/QRIS sendiri disimpan di tabel `payment_channels`, bukan di env,
  // supaya bisa diubah tanpa redeploy.
